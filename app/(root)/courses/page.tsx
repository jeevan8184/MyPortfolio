...
const Courses = () => {
  return (
    <div className=' px-2 flex flex-col gap-8 w-full'>
        <h1 className=' text-red-500 text-4xl max-sm:flex-center'>Courses/Certifications</h1>
        <div className=' flex-center'>
            <div className=' hover:bg-gray-950 max-sm:w-10/12 max-md:w-8/12 max-sm:bg-black max-md:pb-10 grid grid-cols-2 max-md:grid-cols-1 p-3 max-sm:p-2 rounded-2xl border border-gray-200 gap-8'>
